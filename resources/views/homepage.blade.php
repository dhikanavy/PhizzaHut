    ...
    <div class="container">
                ...
                @foreach ($Pizza as $item)
                    <div class="col-md-4">
                        <div class="card shadow p-2 mx-2 my-2">
                            <a href="/pizzadetail/{{ $item->id }}"><img class="card-img-top" src="{{ asset("assets/$item->pizzaimage") }}" alt=""></a>
                            <div class="card-body">
        ...
        @else
            ...
            <div class="text-center mt-3 mb-2">
                <a href="/viewaddpizza" class="btn btn-dark">Add Pizza</a>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card shadow mx-2 my-2">
                        ...
                        <div class="card-footer text-center">  
                            <a href="/vieweditpizza/{{ $item->id }}" class="btn btn-primary">Update Pizza</a>
                            <a href="/viewdeletepizza/{{ $item->id }}" class="btn btn-danger">Delete Pizza</a>
                        </div>
                    </div>
                </div>
                @endforeach
